...
$(gyp_shared_intermediate_dir)/webcore/heap/SaveRegisters_x86.o: $(LOCAL_PATH)/third_party/WebKit/Source/heap/asm/SaveRegisters_x86.asm $(gyp_shared_intermediate_dir)/yasm $(GYP_TARGET_DEPENDENCIES)
	mkdir -p $(gyp_shared_intermediate_dir)/webcore/heap; cd $(gyp_local_path)/third_party/WebKit/Source/heap; "$(gyp_shared_intermediate_dir)/yasm" "-DX64POSIX=1" -DPIC -felf64 -m amd64 -o "$(gyp_shared_intermediate_dir)/webcore/heap/SaveRegisters_x86.o" asm/SaveRegisters_x86.asm
